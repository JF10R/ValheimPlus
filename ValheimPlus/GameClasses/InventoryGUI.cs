...
namespace ValheimPlus.GameClasses
{
    ...
    /// <summary>
    /// Reset the container view when another container is opened. The game only raises
    /// m_firstContainerUpdate in CloseContainer, so a chest opened straight from another skips
    /// InventoryGrid.ResetView and inherits its scroll position.
    /// </summary>
